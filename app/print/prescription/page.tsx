...
type PrintPayload = {
  ...
  // ✅ חדש (אופציונלי) – טלפון מטפל עיקרי (מופיע רק בהדפסה)
      ...
      <div className="wrap" dir="rtl">
        ...
        <div className="page" ref={pageRef}>
            ...
            <div className="head-left">
              ...
              <div className="headText">
                <div className="h-title">
                  מרשם תזונה (SPN/TPN) – נוצר על ידי{" "}
                  <span className="brand">parenta-cal</span>
                </div>
          ...
          <div className="grid">
            <div className="card cardInst">
              ...
              {/* ✅ רק בהדפסה: קוביה קטנה לטלפון מטפל עיקרי */}
            ...
            <div className="card cardFormula">
              ...
              <div className="row3">
                ...
                <div className="box hlBox">
                  ...
                  <div className="box-v">
                    {p.fluidMl.toLocaleString("en-US")}{" "}
        ...
        <style jsx>{`
          ...
          @media print {
            ...
            /* ✅ עבור פקס/סריקה: לא לסמוך על רקעים צבעוניים */
            body {
            ...
            /* ✅ Fax-safe highlighting:
               במקום רקע כהה: מסגרת + פס קטן (accent) */
            .hl,
            .hlMetric,
            .hlBox {
            ...
            .hlBox::before {
              ...
              right: 6px !important; /* RTL: פס בצד ימין */
              width: 4px !important;
              background: rgba(15, 23, 42, 0.55) !important;
              border-radius: 6px !important;
            }

            /* הטקסט המודגש (שם התמיסה) - בלי רקע, עם underline */
            .hlText {
              background: transparent !important;
              border: none !important;
              padding: 0 !important;
            ...
            /* card תוספים היה hl (צהוב) במסך - בהדפסה נהפוך ל-outline */
            .card.hl {
            ...
            /* חתימת רופא - להוציא רקע ורוד, להשאיר מסגרת */
            .signCard {
              background: #ffffff !important;
              border: 1px solid rgba(15, 23, 42, 0.55) !important;
            }
            .cardTitle.red {
              color: #0f172a !important; /* פקס: אדום נהיה אפור/כהה - נעשה אחיד */
            }
          }
        `}</style>
      </div>
