    ...
    return (
      <div className="wrap" dir="rtl">
        ...
        <div className="page" ref={pageRef}>
          ...
          <div className="grid">
            ...
            <div className="card cardInst">
              ...
              {/* ✅ Contact phone empty box */}
              <div className="contactBox">
                <div className="contactK">טלפון איש קשר</div>
                <div className="contactLine" />
              </div>

              {/* print-only caregiver phone */}
            ...
            {/* Formula (emphasized by cleaner border, no side bar) */}
        ...
        <style jsx>{`
          ...
          /* ✅ emphasis without side bar: clean double-outline */
          .emph {
          ...
          /* formula name: underline (no color) */
          .hlText {
            display: inline-block;
            padding-bottom: 2px;
          ...
          @media print {
            ...
            /* caregiver visible only in print */
            .primaryPhonePrint {
              display: block !important;
            }

            /* emphasis: keep only lines (fax-safe) */
            .emph,
            .emphMini {
              box-shadow: none !important;
