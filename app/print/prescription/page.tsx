...
type PrintPayload = {
  ...
  // ✅ חדש (אופציונלי) – טלפון מטפל עיקרי
    ...
    return (
      <div className="wrap" dir="rtl">
          ...
          <div className="head">
            <div className="head-left">
              ...
              <div className="headText">
                ...
                {/* ✅ רוקחים למעלה, לא נחתך: יותר line-height + padding + clamp */}
                <div className="phBox">
        ...
        <style jsx>{`
          ...
          /* ✅ pharmacist block – prevent last digit clipping */
          .phBox {
            margin-top: 8px;
            border: 1px solid #e2e8f0;
            background: rgba(248, 250, 252, 0.95);
            border-radius: 12px;
            padding: 8px 10px 9px 10px; /* ✅ extra bottom padding */
            max-width: 92mm;
          }
          .phK {
            font-size: 10px;
          ...
          /* ✅ print-only caregiver small box (hidden on screen) */
          .primaryPhonePrint {
            display: none;
          }
          .pp-k {
          ...
          @media print {
            ...
            /* pharmacist: a bit smaller + extra bottom padding to prevent clipping */
            .phBox {
            ...
            /* ✅ show caregiver phone box only in print */
            .primaryPhonePrint {
