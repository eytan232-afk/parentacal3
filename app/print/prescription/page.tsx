    ...
    return (
      <div className="wrap" dir="rtl">
          ...
          <div className="head">
            <div className="head-left">
              ...
              <div className="headText">
                ...
                {/* ✅ pharmacist phones ALWAYS visible here, multi-line, clamped */}
                <div className="phBox">
        ...
        <style jsx>{`
          ...
          /* ✅ pharmacist block (wrap + clamp, never single-line) */
          .phBox {
            margin-top: 8px;
            border: 1px solid #e2e8f0;
          ...
          .phV {
            ...
            -webkit-line-clamp: 2; /* ✅ screen: up to 2 lines */
          }
          ...
          @media print {
            ...
            /* ✅ allow up to 3 lines in print so it won't cut */
            .phBox {
            ...
            /* keep sticker large but slightly shorter in print to guarantee space */
            .head-sticker {
              max-width: 105mm !important;
              padding: 8px 10px !important;
            }
            .headStickerBox {
              height: 46mm !important; /* ✅ was 50mm */
            }
            .headStickerMeta {
              font-size: 10px !important;
            }
