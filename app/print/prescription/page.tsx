    ...
    return (
      <div className="wrap" dir="rtl">
              ...
              <div className="mini">
                {p.electrolytes ? (
                  <>
                    ...
                    {fmt(p.electrolytes.chloride, 1)} • Acetate {fmt(p.electrolytes.acetate, 1)}
                  </>
                ) : (
                  <>אלקטרוליטים: —</>
                )}
        ...
        <style jsx>{`
          ...
          /* ✅ כאן התיקון: צר יותר וממורכז */
          .signGrid {
            display: grid;
            grid-template-columns: 150px 150px; /* היה 1fr 1fr */
            justify-content: center; /* מרכז בתוך הכרטיס */
            gap: 10px;
            margin-top: 6px;
          }
          .signCell {
            ...
            gap: 6px;
            align-items: center; /* מרכז גם את התוכן */
          }
          .signLabel {
            font-size: 11px;
            font-weight: 900;
            color: #9f1239;
            align-self: flex-start; /* נשאר יישור יפה */
          }

          /* ✅ קטן יותר */
          .signBox {
            height: 44px; /* היה 54px */
            width: 150px; /* חדש */
            border-radius: 12px;
            background: white;
            border: 1px solid rgba(244, 63, 94, 0.35);
