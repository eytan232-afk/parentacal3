      ...
      <div className="wrap" dir="rtl">
        ...
        <div className="page" ref={pageRef}>
          ...
          <div className="head">
            <div className="head-left">
              ...
              <div className="headText">
                ...
                {/* ✅ moved pharmacist phones to top-right under title */}
                <div className="phLine">
                  <span className="phK">התייעצות רוקח:</span>{" "}
                  <span className="phV">{pharmacistText}</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid">
            ...
            {/* ✅ keep on screen, but HIDE in print to prevent cutting */}
            <div className="card span2 foot cardFoot footHidePrint">
              <div className="footRow">
                <div>
                  <b>התייעצות רוקח:</b> {pharmacistText}
                </div>
                <div className="muted">
                  שירות לקוחות: <b>{p.customerServicePhone}</b>
                </div>
        ...
        <style jsx>{`
          ...
          /* ✅ pharmacist line under title (top-right in RTL) */
          .phLine {
            margin-top: 6px;
            font-size: 11px;
            font-weight: 800;
          ...
          @media print {
            ...
            /* ✅ hide footer card in print to prevent cutting */
            .footHidePrint {
              display: none !important;
            }
