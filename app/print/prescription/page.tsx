      ...
      <div className="wrap" dir="rtl">
        ...
        <div className="page" ref={pageRef}>
          ...
          <div className="head">
            ...
            {/* ✅ במקום שירות לקוחות + ימי טיפול: מדבקת מטופל גדולה (חצי עמוד בערך) */}
        ...
        <style jsx>{`
          ...
          /* ✅ big sticker in header (top-left visually) */
          .head-sticker {
            flex: 0 0 auto;
            width: 100%;
            max-width: 105mm; /* ~חצי דף */
            border: 1px solid #e2e8f0;
