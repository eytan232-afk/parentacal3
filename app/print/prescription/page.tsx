    ...
    return (
      <div className="wrap" dir="rtl">
        ...
        <div className="page" ref={pageRef}>
          ...
          <div className="grid">
            <div className="card span2 cardSticker">
            ...
            {/* ✅ הערות + חתימה/חותמת באותה שורה:
                ב-RTL הערות יהיו מימין, חתימה/חותמת משמאל. גובה זהה. */}
        ...
        <style jsx>{`
          ...
          /* ✅ Pair: Notes (right) + Signature (left) */
          .pairNotesSign {
            grid-column: 1 / span 2;
            display: grid;
            grid-template-columns: 1fr 1fr;
          ...
          /* signature + stamp (same outer size as notes card) */
          .signCard {
            background: rgba(254, 226, 226, 0.65);
            border: 1px solid rgba(244, 63, 94, 0.35);
          }

          /* fill so card can match notes height */
          .signFill {
            flex: 1 1 auto;
            display: flex;
            flex-direction: column;
          ...
          /* inside signature: two small boxes */
          .signGrid {
            display: grid;
            grid-template-columns: 1fr 1fr;
            gap: 10px;
          ...
          @media print {
            ...
            /* make both cards equal height + compact */
            .notesBox {
