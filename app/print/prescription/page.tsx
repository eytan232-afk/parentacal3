      ...
      <div className="wrap" dir="rtl">
        ...
        <style jsx>{`
          ...
          .phBox {
            ...
            border-radius: 12px;
            padding: 8px 10px 12px 10px; /* extra bottom to avoid clipping */
            max-width: 92mm;
          }
          .phK {
            font-size: 10px;
          ...
          .v2 {
            ...
            color: #0f172a;
            font-weight: 900;
            background: rgba(254, 249, 195, 0.18); /* super subtle on screen */
          ...
          .signCard {
            background: rgba(254, 226, 226, 0.20);
          ...
          @media print {
            ...
            /* ✅✅✅ כאן הפתרון: אין צבע בכלל בהדפסה/פקס */
            .hl,
            .hlMetric,
            .hlBox,
            .hlText,
            ...
            /* במקום צבע: מסגרת אפורה + פס צד דק (חד בפקס) */
            .hl,
            .hlMetric,
            .hlBox {
            ...
            .hlBox::before {
              ...
              right: 6px !important; /* RTL */
              width: 2px !important;
              background: rgba(0, 0, 0, 0.28) !important;
              border-radius: 6px !important;
            }

            /* שם התמיסה: בלי רקע, רק underline */
            .hlText {
              border: none !important;
              padding: 0 !important;
              border-radius: 0 !important;
            ...
            /* תאריכים/תוקף/צנתר (v2) – בלי צהוב, רק מסגרת דקה */
            .v2 {
              border: 1px solid rgba(0, 0, 0, 0.22) !important;
            }

            /* חתימת רופא – בלי אדום בכלל בפקס */
            .signCard {
              border: 1px solid rgba(0, 0, 0, 0.28) !important;
            }
            .cardTitle.red,
